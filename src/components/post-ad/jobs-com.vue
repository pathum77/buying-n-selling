...
export default {
    ...
    data() {
        return {
            ...
            displaySub: [],
            categories: [
                { name: 'Accounting & Management', hasSub: false, link: '/' },
                { name: 'Child Care', hasSub: false, link: '/' },
                { name: 'Bar, Food & Hospitality', hasSub: false, link: '/' },
                { name: 'Cleaning & Housekeeping', hasSub: false, link: '/' },
                { name: 'Construction & Trades', hasSub: false, link: '/' },
                { name: 'Customer Service', hasSub: false, link: '/' },
                { name: 'Cannabis Sector', hasSub: false, link: '/' },
                { name: 'Drivers & Security', hasSub: false, link: '/' },
                { name: 'General Labour', hasSub: false, link: '/' },
                { name: 'Graphic & Web Design', hasSub: false, link: '/' },
                { name: 'Healthcare', hasSub: false, link: '/' },
                { name: 'Hair Stylist & Salon', hasSub: false, link: '/' },
                { name: 'Office Manager & Receptionist', hasSub: false, link: '/' },
                { name: 'Part Time & Students', hasSub: false, link: '/' },
                { name: 'Programmers & Computer', hasSub: false, link: '/' },
                { name: 'Sales & Retail Sales', hasSub: false, link: '/' },
                { name: 'TV, Media, & Fashion', hasSub: false, link: '/' },
