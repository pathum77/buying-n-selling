                ...
                <div v-if="subCatIsVisible" class="sub-category-mob">
                    <div class="top dis-fl jus-con-sp-bt al-it-cen">
                        <button class="btn-back pad-mar-no dis-fl al-it-cen" @click="subClose()">
                            ...
                            <p class="pad-mar-no">Back to Vacation Rentals</p>
                        </button>
                        <button class="btn-close" @click="mainClose()"></button>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            displaySub: [],
            categories: [
                { name: 'Colombo', hasSub: false, link: '/' },
                { name: 'Kandy', hasSub: false, link: '/' },
                { name: 'Galle', hasSub: false, link: '/' },
                { name: 'Ampara', hasSub: false, link: '/' },
                { name: 'Anuradhapura', hasSub: false, link: '/' },
                { name: 'Badulla', hasSub: false, link: '/' },
                { name: 'Batticaloa', hasSub: false, link: '/' },
                { name: 'Gampaha', hasSub: false, link: '/' },
                { name: 'Hambantota', hasSub: false, link: '/' },
                { name: 'Jaffna', hasSub: false, link: '/' },
                { name: 'Kalutara', hasSub: false, link: '/' },
                { name: 'Kegalle', hasSub: false, link: '/' },
                { name: 'Kilinochchi', hasSub: false, link: '/' },
                { name: 'Kurunegala', hasSub: false, link: '/' },
                { name: 'Manner', hasSub: false, link: '/' },
                { name: 'Matale', hasSub: false, link: '/' },
                { name: 'Matara', hasSub: false, link: '/' },
                { name: 'Monaragala', hasSub: false, link: '/' },
                { name: 'Mullativu', hasSub: false, link: '/' },
                { name: 'Nuwara Eliya', hasSub: false, link: '/' },
                { name: 'Polonnaruwa', hasSub: false, link: '/' },
                { name: 'Puttalam', hasSub: false, link: '/' },
                { name: 'Ratnapura', hasSub: false, link: '/' },
                { name: 'Trincomalee', hasSub: false, link: '/' },
                { name: 'Vavunia', hasSub: false, link: '/' },
            ],
        }
    },
