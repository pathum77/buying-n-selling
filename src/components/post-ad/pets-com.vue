...
export default {
    ...
    data() {
        return {
            ...
            displaySub: [],
            categories: [
                { name: 'Pets', hasSub: false, link: '/' },
                { name: 'Animal Accessories', hasSub: false, link: '/' },
                { name: 'Farm Animals', hasSub: false, link: '/' },
                { name: 'Veterinary Services', hasSub: false, link: '/' },
                { name: 'Pet Food', hasSub: false, link: '/' },
                { name: 'Lost & Found', hasSub: false, link: '/' },
                { name: 'Other Animals', hasSub: false, link: '/' },
            ],
        }
    },
