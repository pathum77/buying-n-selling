...
export default {
    ...
    data() {
        return {
            ...
            displaySub: [],
            categories: [
                { name: 'Activities & Groups', hasSub: false, link: '/' },
                { name: 'Artists & Musicians', hasSub: false, link: '/' },
                { name: 'Classes & Lessons', hasSub: false, link: '/' },
                { name: 'Events', hasSub: false, link: '/' },
                { name: 'Friendship & Networking', hasSub: false, link: '/' },
                { name: 'Long Lost Relationships', hasSub: false, link: '/' },
                { name: 'Lost & Found', hasSub: false, link: '/' },
                { name: 'Missed Connections', hasSub: false, link: '/' },
                { name: 'Rideshare', hasSub: false, link: '/' },
                { name: 'Sports Teams', hasSub: false, link: '/' },
                { name: 'Volunteers', hasSub: false, link: '/' },
