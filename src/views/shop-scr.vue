    ...
    <div>
        ...
        <div class="main res-py container-xxl">
            ...
            <div class="item-info-wrp dis-fl">
                <div class="info-box">
                    <div class="info-1">
                        <p class="name pad-mar-no">Next Mobile</p>
                    ...
                    <div class="info-3">
                        <p class="pad-mar-no">We are the leading mobile dealer of Gampaha , Giving the sustainable value
                            for the customers.</p>
                    </div>
                </div>
